...
if (! function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('gbaycart.modules.core.config.core_modules'));
    }
}
...
if (! function_exists('fleetcart_version')) {
    /**
     * Get the gbaycart version.
     *
     * @return string
     */
    function fleetcart_version()
    {
        return GbayCart::VERSION;
    }
}
