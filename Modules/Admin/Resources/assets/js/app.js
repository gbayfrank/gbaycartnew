...
$(function () {
    ...
    var o = $.GbayCart.options;

    // Set up the object
    _init();

    // Activate layout
    $.GbayCart.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.GbayCart.tree('.sidebar');
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.GbayCart.pushMenu.activate(o.sidebarToggleSelector);
    }
...
/* ----------------------------------
   - Initialize the GbayCart Object -
   ---------------------------------- */
function _init() {
    ...
    $.GbayCart.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.GbayCart.options.screenSizes;
    ...
    // Tree
    $.GbayCart.tree = function (menu) {
        var animationSpeed = $.GbayCart.options.animationSpeed;
