...
GbayCart.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (GbayCart.dataTable.selected[selector] === undefined) {
            GbayCart.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (! GbayCart.dataTable.selected[this.selector].includes(id)) {
            GbayCart.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        GbayCart.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = GbayCart.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return GbayCart.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        GbayCart.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        GbayCart.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return GbayCart.dataTable.selected[selector];
    }
