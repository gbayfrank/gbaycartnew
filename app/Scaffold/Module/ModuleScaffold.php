...
namespace GbayCart\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use GbayCart\Scaffold\Module\Generators\FilesGenerator;
use GbayCart\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \GbayCart\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \GbayCart\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \GbayCart\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \GbayCart\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The GbayCart {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The GbayCart {$moduleName} Module.\"," . PHP_EOL;
